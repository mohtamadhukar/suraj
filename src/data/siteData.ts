...
export const productCategories: ProductCategory[] = [
  {
    ...
    products: [
      { id: 'fan-blade', name: 'Fan Blades', specs: 'PP/ABS, 16"–24" sizes, custom pitch angles', image: '/images/products/fan-blade.svg', category: 'plastic-parts' },
      { id: 'motor-housing', name: 'Motor Housings', specs: 'ABS/PP, precision-moulded, heat-resistant', image: '/images/products/motor-housing.svg', category: 'plastic-parts' },
      { id: 'guard', name: 'Safety Guards', specs: 'PP, front & rear, finger-safe spacing', image: '/images/products/guard.svg', category: 'plastic-parts' },
      { id: 'base-plate', name: 'Base Components', specs: 'ABS, weighted bases, anti-vibration design', image: '/images/products/base-plate.svg', category: 'plastic-parts' },
    ],
  },
  {
    id: 'table-fans',
    ...
    products: [
      { id: 'table-fan-16', name: '16" Table Fan', specs: '3-speed, oscillating, 55W motor', image: '/images/products/table-fan-16.svg', category: 'table-fans' },
      { id: 'table-fan-18', name: '18" Table Fan', specs: '3-speed, oscillating, 65W motor, wide sweep', image: '/images/products/table-fan-18.svg', category: 'table-fans' },
      { id: 'table-fan-24', name: '24" Industrial Table Fan', specs: 'Heavy-duty, metal guard, 100W motor', image: '/images/products/table-fan-24.svg', category: 'table-fans' },
    ],
  },
  {
    id: 'custom-oem',
    ...
    products: [
      { id: 'custom-part', name: 'Custom Moulded Parts', specs: 'Any shape, PP/ABS/Nylon, MOQ: 5,000 pcs', image: '/images/products/custom-part.svg', category: 'custom-oem' },
      { id: 'custom-housing', name: 'Custom Enclosures', specs: 'Appliance housings, custom colour matching', image: '/images/products/custom-housing.svg', category: 'custom-oem' },
      { id: 'custom-assembly', name: 'Assembly Services', specs: 'Full sub-assembly with QC, packaging, labelling', image: '/images/products/custom-assembly.svg', category: 'custom-oem' },
    ],
  },
];
...
export const clients = [
  ...
  { name: 'Client 6', logo: '/images/clients/client-6.svg' },
  { name: 'Client 7', logo: '/images/clients/client-7.svg' },
  { name: 'Client 8', logo: '/images/clients/client-8.svg' },
  { name: 'Client 9', logo: '/images/clients/client-9.svg' },
  { name: 'Client 10', logo: '/images/clients/client-10.svg' },
];

export const testimonials = [
  {
    quote: 'Suraj Plastics has been our trusted supplier for over a decade. Their consistency in quality and on-time delivery is unmatched in the industry.',
    author: 'Rajesh Kumar',
    designation: 'Head of Procurement',
    company: 'Leading Fan Manufacturer',
  },
  {
    quote: 'We switched to Suraj Plastics for our OEM requirements and saw a 30% improvement in component consistency. Highly recommended for precision parts.',
    author: 'Priya Sharma',
...
export const about = {
  story: [
    'Founded in 1998, Suraj Plastics began as a small workshop with a single injection moulding machine and a vision to deliver world-class plastic components to India\'s fan industry. What started as a family enterprise has grown into one of the region\'s most trusted manufacturing partners.',
...
export const manufacturing = {
  ...
  factoryImage: '/images/factory/factory-overview.svg',
  machinery: [
...
export const seoMeta: Record<string, { title: string; description: string }> = {
  home: {
    title: 'Suraj Plastics — Precision Plastic Manufacturing for Fan Industry & OEM',
  ...
  about: {
    title: 'About Us — Suraj Plastics | 25+ Years of Manufacturing Excellence',
    description: 'Learn about Suraj Plastics — our story, mission, leadership, and ISO-certified quality processes that make us a trusted manufacturing partner.',
  },
  products: {
    title: 'Products — Fan Components, Table Fans & Custom OEM | Suraj Plastics',
  ...
  manufacturing: {
    title: 'Manufacturing & Infrastructure — Suraj Plastics',
  ...
  clients: {
    title: 'Our Clients — Trusted by India\'s Leading Brands | Suraj Plastics',
    description: 'Suraj Plastics is a trusted supplier to top fan manufacturers and consumer brands across India. See our client partnerships and testimonials.',
  },
  contact: {
    title: 'Contact Us — Request a Quote | Suraj Plastics',
